...
public class report extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] type ={"HEART PROBLEMS ","PREGNANCY","NEW BORN BABY" ,"DIABETES"};
        ...
        mbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mfire.collection("Patients").document(FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber()).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
